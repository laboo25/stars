        ...
        {/* <div className="w-[180px] h-screen"></div> */}
          ...
          <div className="banner">
              <div className="image">
                ...
                <img src="https://raw.githubusercontent.com/laboo25/mag-imgs/main/cover/oxanaChic.jpg" alt="" />
              </div>
              <div className="textBox">
                ...
                <p>
                  birth place: <span>Kyiv, UKRAINE</span>
                </p>
                <p>
                  birth date: <span>28-Nov-1999</span>
                </p>
                <p>
                  age: <span id="age" data-year="1999-11-28">{difference}</span><span className='lowercase'>y</span>
                </p>
                <p>
                ...
                <p>
                  measurements: <span>36C―26―36</span>
                </p>
                <p>
                ...
                <p>
                  shoe size: <span className= "text-[red]">undefined</span>
                </p>
                <p>
