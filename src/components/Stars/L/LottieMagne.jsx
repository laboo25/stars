        ...
        {/* <div className="w-[180px] h-screen"></div> */}
          ...
          <div className="banner">
              <div className="image">
                ...
                <img src="https://raw.githubusercontent.com/laboo25/mag-imgs/main/cover/lottieMagne.jpg" alt="" />
              </div>
              <div className="textBox">
                <h3>Lottie magne</h3>
                <p>
                  aliases: <span>lottie mange; nada a; olivia lush</span>
                </p>
                <p>
                  birth place: <span>RUSSIA</span>
                </p>
                <p>
                  birth date: <span>30-Sep-1998</span>
                </p>
                <p>
                  age: <span id="age" data-year="1998-9-30">{difference}</span><span className='lowercase'>y</span>
                </p>
                <p>
                  Profession: <span>adult model, porn star</span>
                </p>
                <p>
                  career: <span>2020—<span className="common active">active</span></span>
                </p>
                <p>
                ...
                <p>
                  measurements: <span>32A―22―34</span>
                </p>
                <p>
                  hair color: <span>auburn</span>
                </p>
                <p>
                  eye color: <span>brown</span>
                </p>
                <p>
                  shoe size: <span className= "text-[]">5 us</span>
                </p>
                <p>
                  height: <span>5'3" [160 Cm]</span>
                </p>
                <p>
