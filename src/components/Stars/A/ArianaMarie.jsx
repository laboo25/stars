          ...
          <div>
            <div className="banner">
              <div className="image">
                ...
                <img src="https://raw.githubusercontent.com/laboo25/mag-imgs/main/cover/arianaMarie.jpg" alt="" />
              </div>
              <div className="textBox">
                <h3>ariana Marie</h3>
                <p>
                    aliases: <span>Adriana Marie</span>
                </p>
                <p>
                    birth place: <span>Texas, US</span>
                </p>
                <p>
                    birth date: <span>15—march—1993</span>
                </p>
                <p>
                    age: <span id="age" data-year="1993-3-15">{difference}</span><span className="lowercase">y</span>
                </p>
                <p>
                    Profession: <span>Porn Star</span>
                </p>
                <p>
                    career: <span>2013—<span className="common active">active</span></span>
                </p>
                <p>
                ...
                <p>
                    measurements: <span>33C―26―35</span>
                </p>
                <p>
                ...
                <p>
                    piercings: <span>Navel; Dermals lower back</span>
                </p>
                <p>
                    tattoos: <span>"One Day I'll Fly Away" with feather on left mid-belly; "15" right upper chest</span>
                </p>
                <p>
                    pubic hair: <span>Trimmed</span>
                </p>
                <p>
                    abaility: <span>anal, DP</span>
                </p>
            </div>
            </div>
          </div>
